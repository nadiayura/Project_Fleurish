      ...
      <section className="bg-[#FEFAE0] py-8" id="aboult">
        <div className="container py-8 px-6 mx-auto">
          ...
          <p className="mt-8 mb-8">
            Menjadi florist lokal terpercaya yang menghadirkan kemudahan, kecepatan, dan keindahan 
            dalam setiap transaksi pembelian bunga secara digital.
            <br />
            <a
          ...
          <p className="mb-8">
          Fleurish adalah usaha florist lokal yang terletak di kota bekasi, yang menjual berbagai jenis 
          bunga seperti mawar, lily, baby breath, dan lainnya dalam bentuk buket, dekorasi meja dan lain 
          sebagainya. Bisnis ini berfokus pada keunikan desain bunga dan pelayanan yang cepat, 
          terutama untuk konsumen yang membutuhkan pesanan dadakan atau instan.
          </p>
        </div>
      </section>
    </>
